...
const ALL_NAV = [
  ...
  { path: '/admin/chemists',      label: 'Chemists & Stockists',icon: '🏪',            key: 'chemists' },
  ...
  { path: '/admin/engagement',    label: 'Doctor Engagement',  icon: '📈',             key: 'engagement' },
  { divider: true, label: 'Performance' },
  { path: '/admin/targets',       label: 'Sales Targets',      icon: '🎯',             key: 'targets' },
  { path: '/admin/leaderboard',   label: 'Leaderboard',        icon: '🏆',             key: 'leaderboard' },
  { path: '/admin/inventory',     label: 'Sample Inventory',   icon: '💊',             key: 'inventory' },
  { divider: true, label: 'Tools' },
  { path: '/admin/appointments',  label: 'Appointments',       icon: '📅',             key: 'appointments' },
  { path: '/admin/notifications', label: 'Notifications',      icon: '📱',             key: 'notifications' },
  { path: '/admin/ai-summary',    label: 'AI Visit Summary',   icon: '🤖',             key: 'ai-summary' },
  { path: '/admin/reports',       label: 'Reports & Alerts',   icon: '📊',             key: 'reports' },
  { path: '/admin/audit',         label: 'HIPAA & Audit',      icon: '🔐',             key: 'audit' },
